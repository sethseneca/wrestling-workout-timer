...
- `whistle-start.m4a` - trimmed AAC conversion built from Freesound sound `218318` by SpliceSound, licensed Creative Commons 0.
- `ready.m4a`, `set.m4a` - trimmed AAC conversions built from Freesound sound `529843` by dastudiospr, licensed Creative Commons 0.
